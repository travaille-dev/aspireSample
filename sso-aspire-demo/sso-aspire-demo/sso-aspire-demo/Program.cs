using sso_aspire_demo.Client.Pages;
using sso_aspire_demo.Client.Weather;
using sso_aspire_demo.Components;
using Microsoft.AspNetCore.Authentication;
using Microsoft.AspNetCore.Components.Authorization;
using Yarp.ReverseProxy.Transforms;
using sso_aspire_demo.LoginUtils;
using sso_aspire_demo;
...
builder.Services.AddAuthentication("MicrosoftOidc")
    ...
    .AddOpenIdConnect("MicrosoftOidc", oidcOptions =>
    {
        ...
        oidcOptions.Scope.Add("<INSERT WEATHER SCOPE>");
        ...
        oidcOptions.Authority = "https://login.microsoftonline.com/<TENANT>/v2.0/";
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(sso_aspire_demo.Client._Imports).Assembly);
